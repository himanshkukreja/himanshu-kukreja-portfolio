-- Create story_comments table for blog discussions
CREATE TABLE IF NOT EXISTS story_comments (
  ...
  parent_id UUID REFERENCES story_comments(id) ON DELETE CASCADE, -- For nested replies
...
-- Create story_comment_votes table to track user votes
