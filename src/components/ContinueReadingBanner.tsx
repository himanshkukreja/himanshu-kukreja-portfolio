...
export default function ContinueReadingBanner({ courseId, lessonTitle }: ContinueReadingBannerProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 dark:from-blue-500/20 dark:via-purple-500/20 dark:to-pink-500/20 rounded-xl border-2 border-blue-500/30 dark:border-blue-500/40 p-6 mb-8">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4 flex-1">
          {/* Icon */}
          <div className="flex-shrink-0 w-12 h-12 bg-blue-500/20 dark:bg-blue-500/30 rounded-full flex items-center justify-center">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-white/50">
              <span>{formatWeekName(lastLesson.week)}</span>
        ...
        <Link
          ...
          className="flex-shrink-0 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors font-medium flex items-center gap-2 group"
        >
