...
export default function AuthPromptBanner({ variant = "learn-page" }: AuthPromptBannerProps) {
  ...
  return (
    <>
      <div className="relative bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-blue-500/10 border border-blue-500/20 rounded-xl p-4 md:p-6 backdrop-blur-sm">
        {/* Dismiss Button */}
        <button
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4 mb-4 md:mb-0">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-1.5 text-white/60 text-xs">
                  {feature.icon}
