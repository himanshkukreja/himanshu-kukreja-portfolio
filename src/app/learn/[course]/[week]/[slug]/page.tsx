          ...
          <nav className="mt-12 pt-8 border-t border-white/10 flex items-center justify-between gap-4">
            {previousResource ? (
              <Link
                ...
                className="flex items-center gap-2 px-4 py-3 bg-white/5 hover:bg-white/10 rounded-lg transition-all group"
              >
                <ChevronLeft className="w-5 h-5 text-white/60 group-hover:text-white group-hover:-translate-x-1 transition-all" />
                <div className="text-left">
                  <div className="text-xs text-white/40">Previous</div>
                  <div className="text-white text-sm font-medium">{previousResource.title}</div>
                </div>
              </Link>
            ) : (
              <div /> // Spacer
            ...
            {nextResource ? (
              ...
              >
                <div className="text-right">
                  ...
                  <div className="text-white text-sm font-medium">{nextResource.title}</div>
                </div>
